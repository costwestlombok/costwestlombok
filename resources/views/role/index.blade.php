...
@section('content')
	<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Listado de Roles</h5>				
					</div>
					...
					<div class="table-responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{{ route('role.edit', $role->id) }}" class="btn btn-defaut">
						...
						<ul class="fab-menu fab-menu-absolute fab-menu-bottom-right" data-fab-toggle="hover">
							<li>
								<a class="fab-menu-btn btn bg-success btn-float btn-rounded btn-icon" href="{{route('role.create')}}">
