            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        <div class="text-right nowrap">\
                            <a href="/catalog/status/' + full.id + '/edit" class="btn btn-xs btn-clean btn-icon">\
                                <i class="fas fa-pen"></i>\
                            </a>\
                            <a href=\'javascript:deleteFn("status", "' + full.id + '");\' class="button btn btn-xs btn-clean btn-icon">\
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{ __('labels.status') }}</h3>
                </div>
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('status.create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>{{ __('labels.create') }} {{ __('labels.status') }}</a>
                    <!--end::Button-->
                </div>
            </div>
            <div class="card-body">
