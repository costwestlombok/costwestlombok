...
<!--end::Page Vendors-->
<script>var COST_URL = "{{ url('api/status') }}";</script>
<script>
    "use strict";
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                			...
                			<a href="/catalog/status/'+ full.id + '/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
