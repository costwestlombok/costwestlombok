            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column mr-auto">
                        <!--begin: Title-->
                        <a href="#"
                            class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1">{{ __('labels.progress_date') }}:
                            ...
                            <div class="d-flex align-items-center pt-2">
                                <div class="progress progress-xs mt-2 mb-2 w-100">
                                    <div class="progress-bar bg-warning" role="progressbar"
                                        style="width: {{number_format($item->programmed_percent)}}%;" aria-valuenow="50"
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                        ...
                        <div class="flex-row-fluid mb-7">
                            ...
                            <div class="d-flex align-items-center pt-2">
                                <div class="progress progress-xs mt-2 mb-2 w-100">
                                    <div class="progress-bar bg-warning" role="progressbar"
                                        style="width: {{number_format($item->real_percent)}}%;" aria-valuenow="50"
                                        aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                ...
                <div class="d-flex align-items-center flex-lg-fill mr-5 my-5 ml-1">
                    ...
                    <div class="d-flex flex-column text-dark-75">
                        ...
                        <span class="font-weight-bolder font-size-h5">
                            <a href="{{url('advance-images/'.$item->id)}}"
                                class="tect-primary">{{ __('labels.create') }}
                                {{ __('labels.image') }}</a>
                        </span>
                    </div>
                </div>
