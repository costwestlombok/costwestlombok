...
<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center">
            ...
            <!--end::Button-->
            <!--begin::Button-->
            <a href="{{ url('project-progress/'.$project->id.'/create') }}" class="btn btn-primary font-weight-bolder"><span
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column mr-auto">
                                <!--begin: Title-->
                                <a href="#"
                                    class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1">Progress/Advance Date : {{ Carbon\Carbon::parse($item->date_of_advance)->format('D, d M Y') }}</a>
                                    <span class="label label-lg label-light-success label-inline font-weight-bold py-4">{{$item->status->status_name}}</span>
                                <!--end::Title-->
                            </div>
                            <!--end::Info-->
                            <!--begin::Toolbar-->
                                        ...
                                        <ul class="navi navi-hover">
                                            ...
                                            <li class="navi-item">
                                                <a href="{{ url('project-tender/'.$item->id) }}" class="navi-link">
                                                    ...
                                                    <span class="navi-text"><i class="flaticon2-pen"></i> &nbsp; Edit</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <!--end::Navigation-->
                        ...
                        <div class="row mt-5 mb-5">
                            <div class="col-md-6">
                                <div class="d-flex flex-column align-items-cente py-2">
                                    <!--begin::Title-->
                                    <p class="text-dark-75 font-weight-bold font-size-lg mb-1">Theme/issues Description</p>
                                    <!--end::Title-->
                                    <!--begin::Data-->
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                            <div class="mr-12 d-flex flex-column mb-7 w-25">
                                ...
                                <span
                                    class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text">{{ number_format($item->scheduled_financing) }}</span>
                            </div>
                            <!--begin::Progress-->
                                ...
                                <span class="d-block font-weight-bold mb-4">Physical Program (%) </span>
                                    <div class="d-flex align-items-center pt-2">
                                        <div class="progress progress-xs mt-2 mb-2 w-100">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: {{number_format($item->programmed_percent)}}%;"
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                            <div class="mr-12 d-flex flex-column mb-7 w-25">
                                ...
                                <span
                                    class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text">{{ number_format($item->real_financing) }}</span>
                            </div>
                            <!--begin::Progress-->
                            <div class="flex-row-fluid mb-7">
                                <span class="d-block font-weight-bold mb-4">Real Physical </span>
                                    <div class="d-flex align-items-center pt-2">
                                        <div class="progress progress-xs mt-2 mb-2 w-100">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: {{number_format($item->real_percent)}}%;"
                                                aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
