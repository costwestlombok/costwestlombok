            ...
            <form method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label"
                                for="guaranties_doc">{{$progress->guaranties_doc ? 'Upload file to change document' : 'Choose file'}}</label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label"
                                for="advance_doc">{{$progress->advance_doc ? 'Upload file to change document' : 'Choose file'}}</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <div class="typeahead">
                            <input class="form-control" value="{{$progress->status->status_name ?? ''}}" id="status_id"
                                name="status_id" type="text" dir="ltr" style="width: 100%" required>
                        </div>
                    </div>
                </div>
                <div class="card-footer">
                    <div class="text-right">
                        ...
                        <button type="submit"
                            class="btn btn-primary ml-2">{{ isset($progress) ? 'Update' : 'Create' }}</button>
                    </div>
                </div>
            </form>
            <!--end::Form-->
