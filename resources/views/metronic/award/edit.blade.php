                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="contract_estimate_cost"
                                                value="{{ isset($tender) ? ($tender->contract_estimate_cost ?? ($tender->project->budget ?? '0')) : (isset($tender) ? ($tender->project->budget ?? '0') : '0') }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="cost"
                                                value="{{ isset($tender) ? ($tender->cost ?? ($tender->project->budget ?? '0')) : (isset($tender) ? ($tender->project->budget ?? '0') : '0') }}" />
                                        </div>
                                    </div>
                                </div>
