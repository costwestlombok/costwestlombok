                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap mt-14">
                            ...
                            <div class="flex-row-fluid mb-7">
                                <span class="d-block font-weight-bold mb-4">Progress - Real
                                    Physical <span class="text-muted font-weight-bold">(Last
                                        update :
                                        {{ date('D, d M Y', strtotime($item->latest_progress->date_of_advance ?? date('d-m-Y'))) }}
                                        )</span>
                        ...
                        <!--begin::Text-->
                        <p class="mb-7 mt-3">
                            {{ str_limit($item->project_description, $limit = 100, $end = '...') }}
                        </p>
                        <!--end::Text-->
                        <!--begin::Blog-->
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="mr-12 d-flex flex-column mb-7">
                                ...
                                <span class="font-weight-bolder font-size-h5 pt-1">
                                    <span class="font-weight-bold text-dark-50">{{$item->duration}}</span>
                                    days</span>
                            </div>
                            <!--end::Item-->
