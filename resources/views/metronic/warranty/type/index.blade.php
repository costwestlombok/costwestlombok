...
<!--end::Page Vendors-->
<script>var COST_URL = "{{ url('api/warranty-type') }}";</script>
<script>
    "use strict";
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                			...
                			<a href="/catalog/warranty-type/'+ full.id + '/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        $(document).on('click', '.button', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "GET",
                            url: "/api/warranty-type/"+ id +"/delete",
