...
<!--end::Page Vendors-->
<script>var COST_URL = "{{ url('api/contact') }}";</script>
<script>
    "use strict";
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                			...
                			<a href="/catalog/contact/'+ full.id + '/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        <table class="table" id="kt_datatable" style="margin-top: 13px !important">
            <thead>
                <tr>
                    ...
                    <th>Name</th>
                    <th>Position</th>
                    <th class="text-center column-fit">Phone</th>
                    <th class="text-center column-fit">Address</th>
