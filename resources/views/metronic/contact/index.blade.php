            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        <div class="text-right nowrap">\
                            <a href="/catalog/contact/' + full.id + '/edit" class="btn btn-xs btn-clean btn-icon">\
                                <i class="fas fa-pen"></i>\
                            </a>\
                            <a href=\'javascript:deleteFn("contact", "' + full.id + '");\' class="button btn btn-xs btn-clean btn-icon">\
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{ __('labels.contact') }}</h3>
                </div>
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('contact.create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>{{ __('labels.create') }} {{ __('labels.contact') }}</a>
                    <!--end::Button-->
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table" id="kt_datatable" style="margin-top: 13px !important">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center column-fit">{{ __('labels.phone') }}</th>
                            <th class="text-center column-fit">{{ __('labels.address') }}</th>
