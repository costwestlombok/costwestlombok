            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        <div class="text-right nowrap">\
                            <a href="/catalog/organization/' + full.id + '/edit" class="btn btn-xs btn-clean btn-icon">\
                                <i class="fas fa-pen"></i>\
                            </a>\
                            <a href=\'javascript:deleteFn("organization", "' + full.id + '");\' class="button btn btn-xs btn-clean btn-icon">\
        ...
        <div class="card card-custom">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ route('organization.create') }}" class="btn btn-primary font-weight-bolder">
