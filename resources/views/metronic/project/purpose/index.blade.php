...
<!--end::Page Vendors-->
<script>var COST_URL = "{{ url('api/purpose') }}";</script>
<script>
    "use strict";
    var KTDatatablesDatapurposeAjaxServer = function () {
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                			...
                			<a href="/catalog/purpose/'+ full.id + '/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
    ...
    jQuery(document).ready(function () {
        KTDatatablesDatapurposeAjaxServer.init();
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">Purpose</h3>
        </div>
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ route('purpose.create') }}" class="btn btn-primary font-weight-bolder">
