...
<!--end::Page Vendors-->
<script>var COST_URL = "{{ url('api/contract_method') }}";</script>
<script>
    "use strict";
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                			...
                			<a href="/catalog/contract_method/'+ full.id + '/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        $(document).on('click', '.button', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "GET",
                            url: "/api/contract_method/"+ id +"/delete",
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">Contract Method</h3>
        </div>
