...
<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">{{ __('labels.contract') }}</h5>
            <!--end::Title-->
            <!--begin::Separator-->
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        ...
        @include('metronic.shared.contract', ['contract' => $contract])
        @endforeach
        @include('metronic.shared.pagination', ['data' => $contracts])
    </div>
    <!--end::Container-->
</div>
@endsection