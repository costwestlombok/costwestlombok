            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        <div class="text-right nowrap">\
                            <a href="/catalog/role/' + full.id + '/edit" class="btn btn-xs btn-clean btn-icon">\
                                <i class="fas fa-pen"></i>\
                            </a>\
                            <a href=\'javascript:deleteFn("role", "' + full.id + '");\' class="button btn btn-xs btn-clean btn-icon">\
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{ __('labels.role') }}</h3>
                </div>
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('role.create') }}" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                        </span>{{ __('labels.create') }} {{ __('labels.role') }}</a>
                    <!--end::Button-->
                </div>
            </div>
            <div class="card-body">
