...
<!--end::Page Vendors-->
<script>var COST_URL = "{{ url('api/subsector') }}";</script>
<script>
    "use strict";
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                			...
                			<a href="/catalog/subsector/'+ full.id + '/edit" class="btn btn-sm btn-clean btn-icon" title="Edit details">\
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            <h3 class="card-label">Subsector</h3>
        </div>
