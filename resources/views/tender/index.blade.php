		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">@lang('labels.tender')</h5>						
				</div>
				...
				<table class="table table-hover invoice-list responsive" id="datatable">
					...
					<tbody>
						...
						<tr>
							<td><?= $obj['id'] ?></td>
							<td><?= $obj['projects_id']; ?></td>
							<td>
								<h5 class="no-margin">
									<a href="projects_list.htm#"><?= $obj['process_number'] ?></a>												
								</h5>
							</td>													
							<td>
								<?= $obj['process_name'] ?>
							...
							<td>
								<span class="label label-success"><?= $obj['statuses_id'] ?></span>
							</td>
