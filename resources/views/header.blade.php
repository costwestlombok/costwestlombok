		...
		<div class="navbar-left pull-left">
			<div class="clearfix">
				<ul class="left-branding pull-left">
					...
					<li>
						<a href="{{ route('dashboard.index') }}"><div class="logo"></div></a>
					</li>
				</ul>				
			</div>
		</div>
			...
			<div class="clearfix">				
				<ul class="pull-right top-right-icons">
					...
					<!--<li class="dropdown apps-dropdown hidden-xs">
						<a href="index.htm#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-grid4"></i></a>
						<div class="dropdown-menu">
							<ul class="shortcuts clearfix">
								<li>
									<a href="http://localhost/templates/penguin/offcanvas/page_emails.php"><i class="icon-envelop"></i>
										<span class="apps-noty">4</span>
										<span class="apps-label">Email</span>
									</a>
								</li>
								<li>
									<a href="http://localhost/templates/penguin/offcanvas/page_tasks.php"><i class="icon-task"></i>
										<span class="apps-noty">12</span>
										<span class="apps-label">Tasks</span>
									</a>
								</li>
								<li>
									<a href="http://localhost/templates/penguin/offcanvas/page_invoice_list.php"><i class="icon-cash4"></i>
										<span class="apps-label">Invoices</span>
									</a>
								</li>
								<li>
									<a href="http://localhost/templates/penguin/offcanvas/page_reports.php"><i class="icon-chart"></i>
										<span class="apps-label">Reports</span>
									</a>
								</li>
								<li>
									<a href="http://localhost/templates/penguin/offcanvas/page_file_manager.php"><i class="icon-attachment"></i>
										<span class="apps-label">Files</span>
									</a>
								</li>
								<li>
									<a href="http://localhost/templates/penguin/offcanvas/page_projects_list.php"><i class="icon-briefcase3"></i>
					...
					<!--<li class="dropdown notifications">
						<a href="index.htm#" class="btn-notification dropdown-toggle" data-toggle="dropdown"><span class="bubble">6</span><i class="icon-bell2"></i></a>
						<div class="dropdown-menu">
							<div>															
								<div class="media-container">											
									<ul class="clearfix">
										...
										<li class="clearfix">
											<a href="index.htm#" class="media-thumb"><span class="media-letter">J</span>
											</a><a href="index.htm#" class="media-title"><strong>Jonaly Smith </strong>At vero eos et... <span class="media-time">1 month ago</span></a>
										</li>												
									</ul>
									<a class="btn btn-link btn-block btn-view-all" href="index.htm#"><span><i class="icon-comment"></i> View all messages</span></a>
								</div>																	
							</div>
						</div>
					</li>-->
					...
					<li><a href="index.htm#" class="right-toggle-switch"><i class="icon-book2"></i></a></li>
					<li><a href="index.htm#" class="right-toggle-switch" style="padding-top: 16px;"><span style="margin-top: 15px">SMQ</span></a></li>
					<li class="dropdown user-dropdown">
						<a href="index.htm#" class="btn-user dropdown-toggle hidden-xs" data-toggle="dropdown">
						<img src="{{asset('assets/images/faces/face1.png')}}" class="img-circle user" alt=""/>
						<!--<i class="icon-user"></i>-->
						</a>
						...
						<div class="dropdown-menu">	
							...
							<ul class="more-apps">
								<li><a href="http://localhost/templates/penguin/offcanvas/user_profile_social.html"><i class="icon-profile"></i> My profile</a></li>
								<li><a href="index.htm#"><i class="icon-envelop5"></i> Inbox <span class="badge badge-danger pull-right">4</span></a></li>
								<li><a href="http://localhost/templates/penguin/offcanvas/user_profile_social.html"><i class="icon-cogs"></i> Profile settings</a></li>
								<li><a href="http://localhost/templates/penguin/offcanvas/login_unlock.html"><i class="icon-lock5"></i> Lock screen</a></li>
							</ul>
