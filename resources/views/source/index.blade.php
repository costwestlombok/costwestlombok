...
@section('content')
	<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Listado de Fuentes</h5>				
					</div>
					...
					<div class="table-responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{{ route('source.edit', $row->id) }}" class="btn btn-defaut">
											<i class="icon-pencil6"></i>
										</a>
									</td>
									<td>
										<form action="{{ route('source.destroy', $row->id)}}" method="post">
											{{ csrf_field() }}
											{{ method_field('DELETE') }}
										...
										<ul class="icons-list">					
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">							
													<li>
														<a href="{{route('source.edit', $row->id)}}">
						...
						<ul class="fab-menu fab-menu-absolute fab-menu-bottom-right" data-fab-toggle="hover">
							<li>
								<a class="fab-menu-btn btn bg-success btn-float btn-rounded btn-icon" href="{{route('source.create')}}">
