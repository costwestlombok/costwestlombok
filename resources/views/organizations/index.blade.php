...
@section('content')
	<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Listado de Organizaciones</h5>				
					</div>
					...
					<div class="table-responsive">
						<table class="table table-togglable table-hover datatable datatable-header-basic">
							<thead>
								<tr>
									...
									<th data-toggle="true">Organization Name</th>
									<th>Actions</th>
									<th data-hide="phone, tablet"></th>
									<th data-hide="phone, tablet"></th>
								</tr>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="{{ route('organization.edit', $org->id) }}" class="btn btn-defaut">
						...
						<ul class="fab-menu fab-menu-absolute fab-menu-bottom-right" data-fab-toggle="hover">
							<li>
								<a class="fab-menu-btn btn bg-success btn-float btn-rounded btn-icon" href="{{route('organization.create')}}">
