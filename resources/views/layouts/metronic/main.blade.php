...
<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
    ...
    <div class="d-flex align-items-center">
        <button class="p-0 btn burger-icon rounded-0 burger-icon-left" id="kt_aside_tablet_and_mobile_toggle">
            <span></span>
        </button>
        @if (Auth::guest())
            <a href="{{ route('login') }}" class="p-0 ml-3 btn btn-hover-text-primary">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <path
                                ...
                                fill="#000000" fill-rule="nonzero" opacity="0.3" transform="translate(15.000000, 12.000000) rotate(-90.000000) translate(-15.000000, -12.000000) " />
                            <path
                                ...
                                fill="#000000" fill-rule="nonzero" transform="translate(14.500000, 12.000000) rotate(-90.000000) translate(-14.500000, -12.000000) " />
                        </g>
                    </svg>
                </span>
            </a>
        @else
            <a href="{{ route('logout') }}" class="p-0 ml-3 btn btn-hover-text-primary">
                <span class="svg-icon svg-icon-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="flex-row d-flex flex-column-fluid page">
        ...
        <div class="aside aside-left d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    <!--begin::Menu Nav-->
                    <ul class="menu-nav">
                        <li class="menu-item {{ request()->segment(1) == '' || request()->segment(1) == 'dashboard' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                        ...
                        @if (Auth::user())
                            ...
                            @if (Auth::user()->type == 'admin')
                                <li class="menu-item {{ request()->segment(1) == 'agency' ? 'menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            @endif
                            <li class="menu-item menu-item-submenu{{ request()->segment(1) == 'catalog' ? ' menu-item-open' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item{{ request()->segment(2) == 'organization' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'organization_unit' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'official' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'role' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'sector' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'subsector' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'source' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'purpose' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'contract_type' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'offerer' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'contact' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'tender_method' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'contract_method' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'warranty-type' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                        ...
                                        <li class="menu-item{{ request()->segment(2) == 'status' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item{{ request()->segment(1) == 'project' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item{{ request()->segment(1) == 'tender' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item{{ request()->segment(1) == 'award' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                            ...
                            <li class="menu-item{{ request()->segment(1) == 'contract' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                        ...
                        @if (Auth::user() && Auth::user()->type == 'admin')
                            <li class="menu-section">
                                <h4 class="menu-text">{{ __('labels.setting') }}</h4>
                                <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                            </li>
                            <li class="menu-item{{ request()->segment(1) == 'banner' ? ' menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="{{ route('banner.index') }}" class="menu-link">
                                    ...
                                    <span class="menu-text">{{ __('labels.banner') }}</span>
                                </a>
                            </li>
                        @endif
                        <li class="menu-section">
                                ...
                                <a href="#change-password" data-toggle="modal" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                                                <polygon fill="#000000" opacity="0.3" transform="translate(8.885842, 16.114158) rotate(-315.000000) translate(-8.885842, -16.114158) "
                                                ...
                                                <path
                                                    ...
                                                    fill="#000000" transform="translate(15.985281, 8.985281) rotate(-315.000000) translate(-15.985281, -8.985281) " />
                                            </g>
                                        </svg>
                                    </span>
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <div id="kt_header" class="header header-fixed">
                ...
                <div class="container d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="mr-3 d-none d-lg-flex align-items-center">
                        <!--begin::Aside Toggle-->
                        <button class="mr-10 btn btn-icon aside-toggle ml-n3" id="kt_aside_desktop_toggle">
                        ...
                        <div class="ml-20 quick-search quick-search-inline w-300px">
                            <!--begin::Form-->
                            <form method="get" class="quick-search-form" action="{{ route('project.index') }}">
                                <div class="rounded input-group bg-light">
                                    ...
                                    <input type="text" name="query" value="{{ request()->get('query') }}" class="form-control h-45px" placeholder="{{ __('labels.search') }} {{ __('labels.project') }}..." />
                    ...
                    <div class="topbar">
                        ...
                        @if (Auth::user())
                            <div class="topbar-item">
                                <a href="https://wa.me/6281805765333" target="_blank" class="mr-6 btn btn-text-success btn-hover-light-success font-weight-bold btn-sm">
                                    <i class="flaticon-whatsapp text-success"></i> CoST Helpdesk
                                </a>
                            </div>
                        @else
                            <div class="topbar-item">
                                <a href="{{ url('documentation') }}" class="btn btn-text-danger btn-hover-light-danger font-weight-bold mr-6 btn-sm {{ request()->segment(1) == 'documentation' ? 'active' : '' }}">
                        ...
                        <div class="dropdown">
                                        ...
                                        @else
                                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                                ...
                                                <g>
                                                    ...
                                                    <path style="fill:#D80027;" d="M322.783,189.219L322.783,189.219L437.02,74.981c-5.252-5.254-10.743-10.266-16.435-15.04l-97.802,97.803V189.219z" />
                                                </g>
                                            </svg>
                                        @endif
                                    </span>
                            ...
                            <!--begin::Dropdown-->
                            <div class="p-0 m-0 dropdown-menu dropdown-menu-right dropdown-menu-anim-up dropdown-menu-md" style="">
                                <!--begin::Navigation-->
                                <ul class="py-5 navi navi-hover">
                                    <li class="navi-item">
                                        <a href="{{ route('localization.switch', 'id') }}" class="navi-link">
                                            ...
                                            <span class="ml-2 navi-text">{{ __('labels.indonesian') }}</span>
                                        </a>
                                    </li>
                                    <li class="navi-item">
                                        <a href="{{ route('localization.switch', 'en') }}" class="navi-link">
                                            ...
                                            <span class="ml-2 navi-text">{{ __('labels.english') }}</span>
                                        </a>
                                    </li>
                                </ul>
                                <!--end::Navigation-->
            ...
            <!--end::Content-->
            <!--begin::Footer-->
            <div class="py-4 bg-white footer d-flex flex-lg-column" id="kt_footer" style="border-top: 1px solid #EBEDF3">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="mt-3 mb-3 d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                    <div>
                                        <a href="https://www.gov.uk/government/organisations/foreign-commonwealth-development-office" target="_blank">
                                            <img src="{{ url('/images/uk-gov.png') }}" alt="UK" class="mb-2 align-top img-responsive" height="50">
                                        </a>
                                        <a href="https://www.undp.org/" target="_blank">
                                            <img src="{{ url('/images/undp.png') }}" alt="UNDP" class="mb-2 mr-3 align-top img-responsive" height="50">
                                        </a>
                                        <a href="https://www1.undp.org/content/fairbiz/en/home.html" target="_blank">
                                            <img src="{{ url('/images/fair-biz.png') }}" alt="FAIR-BIZ" class="mb-2 mr-3 align-top img-responsive" height="50">
                                        </a>
                                        <a href="https://www.government.nl/ministries/ministry-of-foreign-affairs" target="_blank">
                                            <img src="{{ url('/images/netherlands.png') }}" alt="NETHERLANDS" class="mb-2 mr-3 align-top img-responsive" height="50">
                                        </a>
                                    </div>
                                ...
                                <div class="order-2 text-dark order-md-1">
                                    ...
                                    <div>
                                        <span class="mr-2 text-muted font-weight-bold">2024©</span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary font-weight-bold">{{ __($user ? 'labels.save_changes' : 'labels.save') }}</button>
                    </div>
                </div>
            </div>
        </div>
