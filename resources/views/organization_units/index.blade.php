...
@section('content')
	<div class="panel panel-flat">
					<div class="panel-heading">
						<h5 class="panel-title">Listado de Unidades de Organización</h5>				
					</div>
					...
					<div class="table-responsive">
						<table class="table table-togglable table-hover datatable datatable-header-basic">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form action="{{ route('organization_unit.destroy', $unit->id)}}" method="post">
											{{ csrf_field() }}
											{{ method_field('DELETE') }}
										...
										<ul class="icons-list">					
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">							
													<li>
														<a href="{{route('organization_unit.edit', $unit->id)}}">
						...
						<ul class="fab-menu fab-menu-absolute fab-menu-bottom-right" data-fab-toggle="hover">
							<li>
								<a class="fab-menu-btn btn bg-success btn-float btn-rounded btn-icon" href="{{route('organization_unit.create')}}">
