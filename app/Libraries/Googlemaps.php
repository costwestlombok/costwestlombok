...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDhuiN4jkLJ4VYJ1sgcJvlF2fkcsyNeu_Q'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $class 						= 'border-radius';						// A class name if wishing to style the map further through CSS. Can also be useful if wanting it to be responsive etc.
	...
	var $placesAutocompleteInputID	= 'map_search';						// The ID attribute of the textfield that the autocomplete should effect
