...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyAcxyGy-f0MxuzdcxzNmGvFOhC8_5gaTEk'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
